...
9. 行星快照（验前事精度增强，静默不输出给用户）
   -> 选4颗关键行星做深度快照：
      ① L1（命主星）
      ② L10（事业宫主）
      ③ L7 或 DK（优先DK）
      ④ Shadbala最高的行星（与①②③重复则选次高）
   -> 每颗行星先判定角色(P1)和落宫效率(P5)，再综合其他数据：
   ...
   -> 生成快照表：
      ...
      | 行星 | 角色(P1) | 落宫效率(P5) | 尊贵度 | 掌宫SAV | 落宫SAV | 燃烧 | 一句话 |
      |------|---------|------------|-------|--------|--------|------|-------|
      | [L1] | [...] | [...] | [...] | [...] | [...] | [—/⚠️] | [...] |
      | [L10]| [...] | [...] | [...] | [...] | [...] | [—/⚠️] | [...] |
      | [DK] | [...] | [...] | [...] | [...] | [...] | [—/⚠️] | [...] |
   ...
   -> "一句话"列：综合角色+落宫+尊贵度+SAV+燃烧+纹理，
      用一句话说明"这颗星在这张盘里意味着什么"
      示例："Saturn(Yogakaraka+高压红利)入庙在9宫=通过苦修在教育/法律方向出成果"
   -> 附2-3条"验前事增强备注"：基于快照得出的高置信度推断方向
```
...
```
步骤1：读取Step 4预分析数据
  → 第6项"信号预扫"：候选信号来源（Ketu/战争/大运/婚姻/兄弟/经济）
  → 第7项"燃烧检查"：被燃烧的行星信号降级，不作为强信号使用
  → 第8项"Yoga扫描"：检测到的Yoga = 高置信度推断素材
  → 第9项"行星快照"：4颗关键行星的"一句话"列 = 推断精度的核心参考
     ⚠️ 快照中标注"欺骗性风险"的行星 → 相关信号慎用
     ⚠️ 快照中标注"高压红利"的行星 → 可用，但措辞要体现"过程苦"
步骤2：基于快照"一句话"+信号预扫，对候选池A-H逐项评估
  → 信号明确？无矛盾？一步可达？
  → 快照有Yoga → 优先选Yoga相关推断（wow factor最高）
  → 快照有燃烧/陷落 → 该星相关的时间事件降级或跳过
